...
При возникновении исключения, такого как \texttt{Page Fault}, управление переходит в ядро. Ядро анализирует причину и, если ошибка произошла в User Mode, выставляет соответствующий бит в маске ожидающих сигналов (\textit{pending signals}) в {pcb} процесса.
